...
download_realm_ocr_script() {
    local script_url="https://raw.githubusercontent.com/MavisTok/realm-xwPF-ZDY/main/xw_realm_OCR.sh"
...
download_failover_script() {
    local script_url="https://raw.githubusercontent.com/MavisTok/realm-xwPF-ZDY/main/xwFailover.sh"
...
download_speedtest_script() {
    local script_url="https://raw.githubusercontent.com/MavisTok/realm-xwPF-ZDY/main/speedtest.sh"
...
port_traffic_dog_menu() {
    local script_url="https://raw.githubusercontent.com/MavisTok/realm-xwPF-ZDY/main/port-traffic-dog.sh"
...
show_menu() {
    while true; do
        ...
        echo -e "${GREEN}项目开源:${NC}https://github.com/MavisTok/realm-xwPF-ZDY"
